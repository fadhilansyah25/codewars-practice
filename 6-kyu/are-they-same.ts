...
/* 
    ...
    - a or b might be nil or null or None or nothing 
        (except in C++, COBOL, Crystal, D, 
        Dart, Elixir, Fortran, F#, Haskell, Nim, OCaml, Pascal, Perl, PowerShell,
...
console.log(comp(a1, a2)); // should => true
...
console.log(comp(a1, a2)); // should => false
